export const DataProtectionPage = () => {
  return (
    <div className="h-auto text-center text-[#012060] mt-10 px-4">
      <div className="space-y-6">
        ...
        <div className="bg-[#D9D9D9] rounded-3xl text-start shadow-lg p-6 text-[#012060] space-y-6 w-full mx-auto">
          ...
          <div>
            <h4 className="font-semibold mb-2">Wofür nutzen wir Ihre Daten?</h4>
            <p className="mb-2">
          ...
          <div>
            ...
            <p className="mb-2">
              ...
              1 lit. f DSGVO). Sofern eine entsprechende Einwilligung abgefragt
              ...
              auf diese Daten befolgen. Wir setzen folgenden Hoster ein: STRATO
              AG. Otto-Ostrowski-Straße 7, 10249 Berlin, Deutschland.
            </p>
          </div>
          ...
          <div>
            ...
            <h4 className="font-semibold mb-2">
              Die Verantwortlichen für die Datenverarbeitung auf dieser Website
              sind:
            </h4>
          </div>
          ...
          <div>
            ...
            <p className="mb-2">
              ...
              werden. Sofern Sie in die Speicherung von Cookies oder in den
