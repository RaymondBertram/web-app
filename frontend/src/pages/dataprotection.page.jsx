...
export const DataProtectionPage = () => {
  ...
  return (
    <div>
      <SimpleNav />
      <div className="pt-20 md:pt-24 h-auto text-center text-[#012060] px-4">
        <div className="space-y-6">
          <h1>Datenschutz</h1>

          <div className="bg-[#D9D9D9] rounded-3xl text-start shadow-lg p-6 text-[#012060] space-y-6 w-full mx-auto">
            <h3 className="text-xl font-bold">Datenschutzerklärung</h3>

            <div>
              <h4 className="font-semibold">1. Datenschutz auf einen Blick</h4>
              <p className="mb-2 font-semibold">Allgemeine Hinweise</p>
              <p className="mb-2">
            ...
            <div>
              ...
              <p className="mb-2">
                ...
                sobald Sie diese Website betrete
              </p>
            </div>
            ...
            <div>
              <h4 className="font-semibold mb-2">Externes Hosting</h4>
              <p className="mb-2">
                ...
                Einwilligung ist jederzeit widerrufbar. Unser Hoster wird Ihre
                Daten nur insoweit verarbeiten, wie dies zur Erfüllung seiner
                Leistungspflichten erforderlich ist und unsere Weisungen in
                Bezug auf diese Daten befolgen. Wir setzen folgenden Hoster ein:
            ...
            <div>
              ...
              <h4 className="font-semibold mb-2">
                Die Verantwortlichen für die Datenverarbeitung auf dieser
                Website sind:
              </h4>
            </div>
            ...
            <div>
              ...
              <p>HELLO EXPANSION Keller & Keller Projektierung GmbH</p>
              <p>E-Mail: hello@hello-expansion.de</p>
              <p>
            ...
            <div>
              ...
              <p className="mb-2">
                ...
                verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe. Recht
                auf Datenübertragbarkeit Sie haben das Recht, Daten, die wir auf
            ...
            <div>
              ...
              <p className="mb-2">
                ...
                Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu
                verlangen. Wenn Sie die Verarbeitung Ihrer personenbezogenen
                Daten eingeschränkt haben, dürfen diese Daten – von ihrer
            ...
            <div className="text-sm italic text-[#3a4a6b]">
              Quelle:{" "}
              <a
